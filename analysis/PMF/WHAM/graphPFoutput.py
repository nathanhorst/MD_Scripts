...
for w in range(0,windows):
    ...
    print y
    ax1.plot(allR/(factor),y, c=[(w%3==0),(w%3==2),(w%3==1)], label=w, linewidth=1)

spacing=.5
for t in range(0,windows):
	ax1.plot([59-t*2],[0],marker='.',c=[(t%3==0),(t%3==2),(t%3==1)],markersize=20,label=str(t)+'th bias')              
""""  
...
"""
ax1.plot([2*npRadius*10*opmtau],[0], linestyle='None', marker='.', color='magenta', markersize=20,label='OPMcut')
