...
######################################################
system = init.read_xml(filename="Lat108_25_Fcc.xml")
######################################################
...
box_resize = update.box_resize(Lx=variant.linear_interp([(0,box_start),(run_time,box_end)]),Ly=variant.linear_interp([(0,box_start),(run_time,box_end)]),Lz=variant.linear_interp([(0,box_start),(run_time,box_end)]))
