...
######################################################
system = init.read_xml(filename="Lat128_20_Fcc.xml")
######################################################
...
######################################################
rigid_integrator=integrate.nvt_rigid(group=rigid, T=variant.linear_interp([(0,temp_start),(run_time,temp_end)]), tau=0.65)
nonrigid_integrator=integrate.nvt(group=nonrigid, T=variant.linear_interp([(0,temp_start),(run_time,temp_end)]), tau=0.65)
